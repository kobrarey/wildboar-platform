...
\restrict XjohjL8n8Z6ozNKj0xiERjl4bd6VZKx1LnvuP7xiiEh4SQU0gZWVTVR45UxliGH

-- Dumped from database version 16.11
-- Dumped by pg_dump version 16.11

-- Started on 2026-07-27 18:17:50
...
--
-- TOC entry 291 (class 1259 OID 34038)
-- Name: approved_bybit_subaccount_unfreeze_windows; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.approved_bybit_subaccount_unfreeze_windows (
    id bigint NOT NULL,
    fund_id integer,
    ...
    metadata_json jsonb,
    CONSTRAINT approved_bybit_subaccount_unfreeze_windows_status_check CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'used'::character varying, 'expired'::character varying, 'cancelled'::character varying])::text[]))),
    CONSTRAINT approved_bybit_subaccount_unfreeze_windows_time_check CHECK ((expires_at > starts_at))
);


--
-- TOC entry 290 (class 1259 OID 34037)
-- Name: approved_bybit_subaccount_unfreeze_windows_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.approved_bybit_subaccount_unfreeze_windows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 290
-- Name: approved_bybit_subaccount_unfreeze_windows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.approved_bybit_subaccount_unfreeze_windows_id_seq OWNED BY public.approved_bybit_subaccount_unfreeze_windows.id;


--
-- TOC entry 287 (class 1259 OID 33995)
-- Name: approved_bybit_withdrawal_windows; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.approved_bybit_withdrawal_windows (
    id bigint NOT NULL,
    scope character varying(32) DEFAULT 'global'::character varying NOT NULL,
    fund_id integer,
    coin character varying(32) NOT NULL,
    chain character varying(32),
    address character varying(256),
    amount_min numeric(38,18),
    amount_max numeric(38,18),
    starts_at timestamp with time zone NOT NULL,
    expires_at timestamp with time zone NOT NULL,
    reason text,
    status character varying(32) DEFAULT 'active'::character varying NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    metadata_json jsonb,
    CONSTRAINT approved_bybit_withdrawal_windows_scope_check CHECK (((scope)::text = ANY ((ARRAY['global'::character varying, 'fund'::character varying])::text[]))),
    CONSTRAINT approved_bybit_withdrawal_windows_status_check CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'used'::character varying, 'expired'::character varying, 'cancelled'::character varying])::text[]))),
    CONSTRAINT approved_bybit_withdrawal_windows_time_check CHECK ((expires_at > starts_at))
);


--
-- TOC entry 286 (class 1259 OID 33994)
-- Name: approved_bybit_withdrawal_windows_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.approved_bybit_withdrawal_windows_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 286
-- Name: approved_bybit_withdrawal_windows_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.approved_bybit_withdrawal_windows_id_seq OWNED BY public.approved_bybit_withdrawal_windows.id;


--
-- TOC entry 293 (class 1259 OID 34058)
-- Name: bybit_subaccount_freeze_guard_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bybit_subaccount_freeze_guard_events (
    id bigint NOT NULL,
    fund_id integer,
    bybit_sub_uid character varying(64) NOT NULL,
    desired_frozen integer NOT NULL,
    actual_action character varying(32) NOT NULL,
    approved_window_id bigint,
    decision character varying(64) NOT NULL,
    error text,
    raw_json jsonb,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bybit_subaccount_freeze_guard_events_actual_action_check CHECK (((actual_action)::text = ANY ((ARRAY['dry_run_freeze'::character varying, 'dry_run_unfreeze'::character varying, 'freeze_success'::character varying, 'unfreeze_success'::character varying, 'freeze_failed'::character varying, 'unfreeze_failed'::character varying, 'skipped_no_change'::character varying])::text[]))),
    CONSTRAINT bybit_subaccount_freeze_guard_events_decision_check CHECK (((decision)::text = ANY ((ARRAY['freeze_required'::character varying, 'unfreeze_window_active'::character varying, 'api_error_fail_closed'::character varying, 'dry_run'::character varying, 'skipped'::character varying])::text[]))),
    CONSTRAINT bybit_subaccount_freeze_guard_events_desired_frozen_check CHECK ((desired_frozen = ANY (ARRAY[0, 1])))
);


--
-- TOC entry 292 (class 1259 OID 34057)
-- Name: bybit_subaccount_freeze_guard_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bybit_subaccount_freeze_guard_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 292
-- Name: bybit_subaccount_freeze_guard_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bybit_subaccount_freeze_guard_events_id_seq OWNED BY public.bybit_subaccount_freeze_guard_events.id;


--
-- TOC entry 289 (class 1259 OID 34017)
-- Name: bybit_withdrawal_watchdog_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bybit_withdrawal_watchdog_events (
    id bigint NOT NULL,
    bybit_withdrawal_id character varying(128) NOT NULL,
    coin character varying(32),
    chain character varying(32),
    address character varying(256),
    amount numeric(38,18),
    bybit_status character varying(64),
    source_detected character varying(64) DEFAULT 'bybit_master_api'::character varying NOT NULL,
    approved_window_id bigint,
    decision character varying(64) NOT NULL,
    ...
    raw_json jsonb,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT bybit_withdrawal_watchdog_events_decision_check CHECK (((decision)::text = ANY ((ARRAY['allowed'::character varying, 'unexpected'::character varying, 'cancel_attempted'::character varying, 'cancel_success'::character varying, 'cancel_failed'::character varying, 'api_unavailable_fail_closed'::character varying])::text[])))
);


--
-- TOC entry 288 (class 1259 OID 34016)
-- Name: bybit_withdrawal_watchdog_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.bybit_withdrawal_watchdog_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 288
-- Name: bybit_withdrawal_watchdog_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.bybit_withdrawal_watchdog_events_id_seq OWNED BY public.bybit_withdrawal_watchdog_events.id;
...
CREATE TABLE public.fee_wallet_swaps (
    ...
    CONSTRAINT fee_wallet_swaps_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'success'::character varying, 'failed'::character varying, 'skipped'::character varying, 'waiting_for_gas'::character varying])::text[]))),
...
--
-- TOC entry 295 (class 1259 OID 56814)
-- Name: fund_bsc_transaction_intents; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 294 (class 1259 OID 56813)
-- Name: fund_bsc_transaction_intents_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.fund_bsc_transaction_intents_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 294
-- Name: fund_bsc_transaction_intents_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.fund_bsc_transaction_intents_id_seq OWNED BY public.fund_bsc_transaction_intents.id;
...
CREATE TABLE public.fund_negative_bybit_flows (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    withdrawal_policy_version character varying(64),
    coin_info_snapshot_json jsonb,
    universal_transfer_intent_json jsonb,
    withdrawal_intent_json jsonb,
    universal_transfer_submitted_at timestamp with time zone,
    withdrawal_submitted_at timestamp with time zone,
    settlement_wallet_balance_before_usdt numeric(30,10),
    settlement_wallet_balance_after_usdt numeric(30,10),
    settlement_wallet_receipt_confirmations integer,
    settlement_wallet_receipt_block_number bigint,
    CONSTRAINT fund_negative_bybit_flows_status_check CHECK (((status)::text = ANY ((ARRAY['created'::character varying, 'preflight_passed'::character varying, 'preflight_failed_requires_review'::character varying, 'universal_transfer_intent_prepared'::character varying, 'universal_transfer_submitting'::character varying, 'universal_transfer_reconciling'::character varying, 'universal_transfer_mocked'::character varying, 'universal_transfer_reconciled'::character varying, 'master_balance_confirmed'::character varying, 'withdrawal_intent_prepared'::character varying, 'withdrawal_submitting'::character varying, 'withdrawal_reconciling'::character varying, 'withdrawal_mocked'::character varying, 'withdrawal_reconciled'::character varying, 'settlement_wallet_receipt_pending'::character varying, 'settlement_wallet_receipt_confirmed'::character varying, 'completed'::character varying, 'failed_requires_review'::character varying])::text[])))
);
...
CREATE TABLE public.fund_orders (
    ...
    redeem_reserve_released_shares numeric(30,10) DEFAULT 0 NOT NULL,
...
--
-- TOC entry 285 (class 1259 OID 33982)
-- Name: platform_emergency_locks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.platform_emergency_locks (
    id bigint NOT NULL,
    status character varying(32) DEFAULT 'active'::character varying NOT NULL,
    reason text NOT NULL,
    ...
    resolve_reason text,
    metadata_json jsonb,
    CONSTRAINT platform_emergency_locks_status_check CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'resolved'::character varying])::text[])))
);


--
-- TOC entry 284 (class 1259 OID 33981)
-- Name: platform_emergency_locks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.platform_emergency_locks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 284
-- Name: platform_emergency_locks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.platform_emergency_locks_id_seq OWNED BY public.platform_emergency_locks.id;
...
CREATE TABLE public.wallet_transfers (
    ...
    next_retry_at timestamp with time zone,
    last_gas_alert_at timestamp with time zone,
    CONSTRAINT wallet_transfers_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'processing'::character varying, 'waiting_for_gas'::character varying, 'success'::character varying, 'failed'::character varying])::text[])))
);
...
--
-- TOC entry 5065 (class 2604 OID 34041)
-- Name: approved_bybit_subaccount_unfreeze_windows id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approved_bybit_subaccount_unfreeze_windows ALTER COLUMN id SET DEFAULT nextval('public.approved_bybit_subaccount_unfreeze_windows_id_seq'::regclass);


--
-- TOC entry 5057 (class 2604 OID 33998)
-- Name: approved_bybit_withdrawal_windows id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approved_bybit_withdrawal_windows ALTER COLUMN id SET DEFAULT nextval('public.approved_bybit_withdrawal_windows_id_seq'::regclass);


--
-- TOC entry 5068 (class 2604 OID 34061)
-- Name: bybit_subaccount_freeze_guard_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_subaccount_freeze_guard_events ALTER COLUMN id SET DEFAULT nextval('public.bybit_subaccount_freeze_guard_events_id_seq'::regclass);


--
-- TOC entry 5061 (class 2604 OID 34020)
-- Name: bybit_withdrawal_watchdog_events id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_withdrawal_watchdog_events ALTER COLUMN id SET DEFAULT nextval('public.bybit_withdrawal_watchdog_events_id_seq'::regclass);


--
-- TOC entry 4954 (class 2604 OID 33193)
...
--
-- TOC entry 4994 (class 2604 OID 33426)
...
--
-- TOC entry 5000 (class 2604 OID 33454)
...
--
-- TOC entry 5070 (class 2604 OID 56817)
-- Name: fund_bsc_transaction_intents id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents ALTER COLUMN id SET DEFAULT nextval('public.fund_bsc_transaction_intents_id_seq'::regclass);


--
-- TOC entry 4988 (class 2604 OID 33366)
...
--
-- TOC entry 4949 (class 2604 OID 33124)
...
--
-- TOC entry 4950 (class 2604 OID 33139)
...
--
-- TOC entry 4962 (class 2604 OID 33224)
...
--
-- TOC entry 4893 (class 2604 OID 32931)
...
--
-- TOC entry 5021 (class 2604 OID 33646)
...
--
-- TOC entry 5039 (class 2604 OID 33805)
...
--
-- TOC entry 5027 (class 2604 OID 33693)
...
--
-- TOC entry 5033 (class 2604 OID 33739)
...
--
-- TOC entry 5011 (class 2604 OID 33554)
...
--
-- TOC entry 5015 (class 2604 OID 33578)
...
--
-- TOC entry 5052 (class 2604 OID 33918)
...
--
-- TOC entry 5047 (class 2604 OID 33884)
...
--
-- TOC entry 5043 (class 2604 OID 33857)
...
--
-- TOC entry 5005 (class 2604 OID 33512)
...
--
-- TOC entry 4941 (class 2604 OID 33081)
...
--
-- TOC entry 4969 (class 2604 OID 33271)
...
--
-- TOC entry 4980 (class 2604 OID 33308)
...
--
-- TOC entry 4964 (class 2604 OID 33248)
...
--
-- TOC entry 4894 (class 2604 OID 32932)
...
--
-- TOC entry 5054 (class 2604 OID 33985)
-- Name: platform_emergency_locks id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.platform_emergency_locks ALTER COLUMN id SET DEFAULT nextval('public.platform_emergency_locks_id_seq'::regclass);


--
-- TOC entry 4900 (class 2604 OID 32933)
...
--
-- TOC entry 4946 (class 2604 OID 33103)
...
--
-- TOC entry 4905 (class 2604 OID 32934)
...
--
-- TOC entry 4908 (class 2604 OID 32935)
...
--
-- TOC entry 4951 (class 2604 OID 33177)
...
--
-- TOC entry 4910 (class 2604 OID 32936)
...
--
-- TOC entry 4917 (class 2604 OID 32937)
...
--
-- TOC entry 4928 (class 2604 OID 32938)
...
--
-- TOC entry 4938 (class 2604 OID 33050)
...
--
-- TOC entry 5379 (class 2606 OID 34049)
-- Name: approved_bybit_subaccount_unfreeze_windows approved_bybit_subaccount_unfreeze_windows_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approved_bybit_subaccount_unfreeze_windows
    ADD CONSTRAINT approved_bybit_subaccount_unfreeze_windows_pkey PRIMARY KEY (id);


--
-- TOC entry 5370 (class 2606 OID 34005)
-- Name: approved_bybit_withdrawal_windows approved_bybit_withdrawal_windows_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approved_bybit_withdrawal_windows
    ADD CONSTRAINT approved_bybit_withdrawal_windows_pkey PRIMARY KEY (id);


--
-- TOC entry 5383 (class 2606 OID 34069)
-- Name: bybit_subaccount_freeze_guard_events bybit_subaccount_freeze_guard_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_subaccount_freeze_guard_events
    ADD CONSTRAINT bybit_subaccount_freeze_guard_events_pkey PRIMARY KEY (id);


--
-- TOC entry 5374 (class 2606 OID 34027)
-- Name: bybit_withdrawal_watchdog_events bybit_withdrawal_watchdog_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_withdrawal_watchdog_events
    ADD CONSTRAINT bybit_withdrawal_watchdog_events_pkey PRIMARY KEY (id);


--
-- TOC entry 5211 (class 2606 OID 33204)
...
--
-- TOC entry 5256 (class 2606 OID 33435)
...
--
-- TOC entry 5276 (class 2606 OID 33462)
...
--
-- TOC entry 5388 (class 2606 OID 56851)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_payout_leg_uq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_payout_leg_uq UNIQUE (payout_leg_id);


--
-- TOC entry 5390 (class 2606 OID 56825)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_pkey PRIMARY KEY (id);


--
-- TOC entry 5392 (class 2606 OID 56847)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_scope_key_uq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_scope_key_uq UNIQUE (scope_key);


--
-- TOC entry 5394 (class 2606 OID 56849)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_source_nonce_uq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_source_nonce_uq UNIQUE (from_address, source_nonce);


--
-- TOC entry 5250 (class 2606 OID 33374)
...
--
-- TOC entry 5198 (class 2606 OID 33133)
...
--
-- TOC entry 5200 (class 2606 OID 33126)
...
--
-- TOC entry 5203 (class 2606 OID 33148)
...
--
-- TOC entry 5205 (class 2606 OID 33141)
...
--
-- TOC entry 5219 (class 2606 OID 33230)
...
--
-- TOC entry 5215 (class 2606 OID 33214)
...
--
-- TOC entry 5129 (class 2606 OID 32940)
...
--
-- TOC entry 5131 (class 2606 OID 32942)
...
--
-- TOC entry 5311 (class 2606 OID 33655)
...
--
-- TOC entry 5315 (class 2606 OID 33659)
...
--
-- TOC entry 5318 (class 2606 OID 33657)
...
--
-- TOC entry 5342 (class 2606 OID 33816)
...
--
-- TOC entry 5344 (class 2606 OID 33812)
...
--
-- TOC entry 5347 (class 2606 OID 33814)
...
--
-- TOC entry 5324 (class 2606 OID 33706)
...
--
-- TOC entry 5327 (class 2606 OID 33702)
...
--
-- TOC entry 5330 (class 2606 OID 33704)
...
--
-- TOC entry 5335 (class 2606 OID 33749)
...
--
-- TOC entry 5291 (class 2606 OID 33561)
...
--
-- TOC entry 5294 (class 2606 OID 33563)
...
--
-- TOC entry 5297 (class 2606 OID 33589)
...
--
-- TOC entry 5306 (class 2606 OID 33587)
...
--
-- TOC entry 5364 (class 2606 OID 33923)
...
--
-- TOC entry 5357 (class 2606 OID 33895)
...
--
-- TOC entry 5359 (class 2606 OID 33893)
...
--
-- TOC entry 5351 (class 2606 OID 33864)
...
--
-- TOC entry 5353 (class 2606 OID 33866)
...
--
-- TOC entry 5285 (class 2606 OID 33521)
...
--
-- TOC entry 5189 (class 2606 OID 33086)
...
--
-- TOC entry 5244 (class 2606 OID 33351)
...
--
-- TOC entry 5230 (class 2606 OID 33285)
...
--
-- TOC entry 5237 (class 2606 OID 33316)
...
--
-- TOC entry 5239 (class 2606 OID 51523)
...
--
-- TOC entry 5224 (class 2606 OID 33256)
...
--
-- TOC entry 5133 (class 2606 OID 32944)
...
--
-- TOC entry 5135 (class 2606 OID 32946)
...
--
-- TOC entry 5137 (class 2606 OID 32948)
...
--
-- TOC entry 5368 (class 2606 OID 33991)
-- Name: platform_emergency_locks platform_emergency_locks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.platform_emergency_locks
    ADD CONSTRAINT platform_emergency_locks_pkey PRIMARY KEY (id);


--
-- TOC entry 5139 (class 2606 OID 32950)
...
--
-- TOC entry 5142 (class 2606 OID 32952)
...
--
-- TOC entry 5193 (class 2606 OID 33107)
...
--
-- TOC entry 5195 (class 2606 OID 33109)
...
--
-- TOC entry 5144 (class 2606 OID 32954)
...
--
-- TOC entry 5146 (class 2606 OID 32956)
...
--
-- TOC entry 5149 (class 2606 OID 32958)
...
--
-- TOC entry 5151 (class 2606 OID 32960)
...
--
-- TOC entry 5207 (class 2606 OID 33181)
...
--
-- TOC entry 5156 (class 2606 OID 32962)
...
--
-- TOC entry 5161 (class 2606 OID 32964)
...
--
-- TOC entry 5163 (class 2606 OID 32966)
...
--
-- TOC entry 5170 (class 2606 OID 32968)
...
--
-- TOC entry 5173 (class 2606 OID 32970)
...
--
-- TOC entry 5180 (class 2606 OID 33054)
...
--
-- TOC entry 5182 (class 2606 OID 33056)
...
--
-- TOC entry 5177 (class 2606 OID 33044)
...
--
-- TOC entry 5375 (class 1259 OID 34034)
-- Name: bybit_withdrawal_watchdog_events_withdrawal_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX bybit_withdrawal_watchdog_events_withdrawal_id_idx ON public.bybit_withdrawal_watchdog_events USING btree (bybit_withdrawal_id);


--
-- TOC entry 5209 (class 1259 OID 33206)
...
--
-- TOC entry 5212 (class 1259 OID 33205)
...
--
-- TOC entry 5252 (class 1259 OID 33448)
...
--
-- TOC entry 5253 (class 1259 OID 33505)
...
--
-- TOC entry 5254 (class 1259 OID 33447)
...
--
-- TOC entry 5257 (class 1259 OID 33506)
...
--
-- TOC entry 5258 (class 1259 OID 33446)
...
--
-- TOC entry 5259 (class 1259 OID 33504)
...
--
-- TOC entry 5260 (class 1259 OID 33483)
...
--
-- TOC entry 5261 (class 1259 OID 33484)
...
--
-- TOC entry 5262 (class 1259 OID 33485)
...
--
-- TOC entry 5263 (class 1259 OID 33972)
...
--
-- TOC entry 5264 (class 1259 OID 33494)
...
--
-- TOC entry 5265 (class 1259 OID 33500)
...
--
-- TOC entry 5266 (class 1259 OID 33974)
...
--
-- TOC entry 5267 (class 1259 OID 33495)
...
--
-- TOC entry 5268 (class 1259 OID 33493)
...
--
-- TOC entry 5269 (class 1259 OID 33486)
...
--
-- TOC entry 5270 (class 1259 OID 33501)
...
--
-- TOC entry 5271 (class 1259 OID 33499)
...
--
-- TOC entry 5272 (class 1259 OID 33971)
...
--
-- TOC entry 5273 (class 1259 OID 33488)
...
--
-- TOC entry 5274 (class 1259 OID 33496)
...
--
-- TOC entry 5277 (class 1259 OID 33497)
...
--
-- TOC entry 5278 (class 1259 OID 33973)
...
--
-- TOC entry 5279 (class 1259 OID 33487)
...
--
-- TOC entry 5245 (class 1259 OID 33380)
...
--
-- TOC entry 5246 (class 1259 OID 33421)
...
--
-- TOC entry 5247 (class 1259 OID 33383)
...
--
-- TOC entry 5248 (class 1259 OID 33382)
...
--
-- TOC entry 5251 (class 1259 OID 33381)
...
--
-- TOC entry 5196 (class 1259 OID 33134)
...
--
-- TOC entry 5201 (class 1259 OID 33149)
...
--
-- TOC entry 5216 (class 1259 OID 33237)
...
--
-- TOC entry 5217 (class 1259 OID 33236)
...
--
-- TOC entry 5127 (class 1259 OID 32971)
...
--
-- TOC entry 5309 (class 1259 OID 33682)
...
--
-- TOC entry 5312 (class 1259 OID 33686)
...
--
-- TOC entry 5313 (class 1259 OID 33684)
...
--
-- TOC entry 5316 (class 1259 OID 33683)
...
--
-- TOC entry 5319 (class 1259 OID 33685)
...
--
-- TOC entry 5320 (class 1259 OID 33688)
...
--
-- TOC entry 5321 (class 1259 OID 33687)
...
--
-- TOC entry 5338 (class 1259 OID 33847)
...
--
-- TOC entry 5339 (class 1259 OID 33844)
...
--
-- TOC entry 5340 (class 1259 OID 33846)
...
--
-- TOC entry 5345 (class 1259 OID 33845)
...
--
-- TOC entry 5322 (class 1259 OID 33795)
...
--
-- TOC entry 5325 (class 1259 OID 33793)
...
--
-- TOC entry 5328 (class 1259 OID 33794)
...
--
-- TOC entry 5331 (class 1259 OID 33796)
...
--
-- TOC entry 5332 (class 1259 OID 33800)
...
--
-- TOC entry 5333 (class 1259 OID 33798)
...
--
-- TOC entry 5336 (class 1259 OID 33799)
...
--
-- TOC entry 5337 (class 1259 OID 33797)
...
--
-- TOC entry 5287 (class 1259 OID 33631)
...
--
-- TOC entry 5288 (class 1259 OID 33630)
...
--
-- TOC entry 5289 (class 1259 OID 33608)
...
--
-- TOC entry 5292 (class 1259 OID 33609)
...
--
-- TOC entry 5295 (class 1259 OID 33607)
...
--
-- TOC entry 5298 (class 1259 OID 33610)
...
--
-- TOC entry 5299 (class 1259 OID 33634)
...
--
-- TOC entry 5300 (class 1259 OID 33635)
...
--
-- TOC entry 5301 (class 1259 OID 33633)
...
--
-- TOC entry 5302 (class 1259 OID 33632)
...
--
-- TOC entry 5303 (class 1259 OID 33611)
...
--
-- TOC entry 5304 (class 1259 OID 33613)
...
--
-- TOC entry 5307 (class 1259 OID 33614)
...
--
-- TOC entry 5308 (class 1259 OID 33612)
...
--
-- TOC entry 5361 (class 1259 OID 33953)
...
--
-- TOC entry 5362 (class 1259 OID 33954)
...
--
-- TOC entry 5365 (class 1259 OID 33955)
...
--
-- TOC entry 5354 (class 1259 OID 33950)
...
--
-- TOC entry 5355 (class 1259 OID 33951)
...
--
-- TOC entry 5360 (class 1259 OID 33952)
...
--
-- TOC entry 5348 (class 1259 OID 33948)
...
--
-- TOC entry 5349 (class 1259 OID 33949)
...
--
-- TOC entry 5280 (class 1259 OID 33544)
...
--
-- TOC entry 5281 (class 1259 OID 33542)
...
--
-- TOC entry 5282 (class 1259 OID 33540)
...
--
-- TOC entry 5283 (class 1259 OID 33541)
...
--
-- TOC entry 5286 (class 1259 OID 33543)
...
--
-- TOC entry 5183 (class 1259 OID 33300)
...
--
-- TOC entry 5184 (class 1259 OID 33392)
...
--
-- TOC entry 5185 (class 1259 OID 33548)
...
--
-- TOC entry 5186 (class 1259 OID 33098)
...
--
-- TOC entry 5187 (class 1259 OID 33391)
...
--
-- TOC entry 5190 (class 1259 OID 33547)
...
--
-- TOC entry 5191 (class 1259 OID 33097)
...
--
-- TOC entry 5225 (class 1259 OID 33417)
...
--
-- TOC entry 5226 (class 1259 OID 33291)
...
--
-- TOC entry 5227 (class 1259 OID 33418)
...
--
-- TOC entry 5228 (class 1259 OID 33549)
...
--
-- TOC entry 5231 (class 1259 OID 33395)
...
--
-- TOC entry 5232 (class 1259 OID 33339)
...
--
-- TOC entry 5233 (class 1259 OID 33413)
...
--
-- TOC entry 5234 (class 1259 OID 33340)
...
--
-- TOC entry 5235 (class 1259 OID 33412)
...
--
-- TOC entry 5240 (class 1259 OID 33409)
...
--
-- TOC entry 5241 (class 1259 OID 33342)
...
--
-- TOC entry 5220 (class 1259 OID 33263)
...
--
-- TOC entry 5221 (class 1259 OID 33262)
...
--
-- TOC entry 5222 (class 1259 OID 33264)
...
--
-- TOC entry 5380 (class 1259 OID 34055)
-- Name: idx_approved_bybit_subaccount_unfreeze_windows_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approved_bybit_subaccount_unfreeze_windows_active ON public.approved_bybit_subaccount_unfreeze_windows USING btree (bybit_sub_uid, starts_at, expires_at) WHERE ((status)::text = 'active'::text);


--
-- TOC entry 5381 (class 1259 OID 34056)
-- Name: idx_approved_bybit_subaccount_unfreeze_windows_fund; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approved_bybit_subaccount_unfreeze_windows_fund ON public.approved_bybit_subaccount_unfreeze_windows USING btree (fund_id, status, starts_at, expires_at);


--
-- TOC entry 5371 (class 1259 OID 34014)
-- Name: idx_approved_bybit_withdrawal_windows_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approved_bybit_withdrawal_windows_active ON public.approved_bybit_withdrawal_windows USING btree (status, starts_at, expires_at);


--
-- TOC entry 5372 (class 1259 OID 34015)
-- Name: idx_approved_bybit_withdrawal_windows_fund; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_approved_bybit_withdrawal_windows_fund ON public.approved_bybit_withdrawal_windows USING btree (fund_id, status, starts_at, expires_at);


--
-- TOC entry 5384 (class 1259 OID 34082)
-- Name: idx_bybit_subaccount_freeze_guard_events_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bybit_subaccount_freeze_guard_events_created ON public.bybit_subaccount_freeze_guard_events USING btree (created_at DESC);


--
-- TOC entry 5385 (class 1259 OID 34081)
-- Name: idx_bybit_subaccount_freeze_guard_events_decision; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bybit_subaccount_freeze_guard_events_decision ON public.bybit_subaccount_freeze_guard_events USING btree (decision, created_at DESC);


--
-- TOC entry 5386 (class 1259 OID 34080)
-- Name: idx_bybit_subaccount_freeze_guard_events_subuid_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bybit_subaccount_freeze_guard_events_subuid_created ON public.bybit_subaccount_freeze_guard_events USING btree (bybit_sub_uid, created_at DESC);


--
-- TOC entry 5376 (class 1259 OID 34035)
-- Name: idx_bybit_withdrawal_watchdog_events_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bybit_withdrawal_watchdog_events_created ON public.bybit_withdrawal_watchdog_events USING btree (created_at DESC);


--
-- TOC entry 5377 (class 1259 OID 34036)
-- Name: idx_bybit_withdrawal_watchdog_events_decision; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bybit_withdrawal_watchdog_events_decision ON public.bybit_withdrawal_watchdog_events USING btree (decision, created_at DESC);


--
-- TOC entry 5213 (class 1259 OID 33980)
-- Name: idx_fee_wallet_swaps_waiting_for_gas; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fee_wallet_swaps_waiting_for_gas ON public.fee_wallet_swaps USING btree (wallet_type, status, next_retry_at) WHERE ((status)::text = 'waiting_for_gas'::text);


--
-- TOC entry 5395 (class 1259 OID 56853)
-- Name: idx_fund_bsc_transaction_intents_payout_batch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fund_bsc_transaction_intents_payout_batch ON public.fund_bsc_transaction_intents USING btree (payout_batch_id);


--
-- TOC entry 5396 (class 1259 OID 56852)
-- Name: idx_fund_bsc_transaction_intents_settlement_batch; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fund_bsc_transaction_intents_settlement_batch ON public.fund_bsc_transaction_intents USING btree (settlement_batch_id);


--
-- TOC entry 5397 (class 1259 OID 56854)
-- Name: idx_fund_bsc_transaction_intents_status_updated; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fund_bsc_transaction_intents_status_updated ON public.fund_bsc_transaction_intents USING btree (status, updated_at);


--
-- TOC entry 5242 (class 1259 OID 33979)
-- Name: idx_fund_settlement_transfers_gas_waiting; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_fund_settlement_transfers_gas_waiting ON public.fund_settlement_transfers USING btree (fund_id, batch_id, transfer_type, to_address, status, next_retry_at) WHERE ((status)::text = ANY ((ARRAY['pending'::character varying, 'processing'::character varying, 'waiting_for_gas'::character varying])::text[]));


--
-- TOC entry 5366 (class 1259 OID 33993)
-- Name: idx_platform_emergency_locks_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_platform_emergency_locks_active ON public.platform_emergency_locks USING btree (status, created_at DESC) WHERE ((status)::text = 'active'::text);


--
-- TOC entry 5140 (class 1259 OID 32972)
...
--
-- TOC entry 5158 (class 1259 OID 32973)
...
--
-- TOC entry 5164 (class 1259 OID 32974)
...
--
-- TOC entry 5165 (class 1259 OID 32975)
...
--
-- TOC entry 5166 (class 1259 OID 33073)
...
--
-- TOC entry 5167 (class 1259 OID 33978)
-- Name: idx_wallet_transfers_withdraw_gas_retry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_wallet_transfers_withdraw_gas_retry ON public.wallet_transfers USING btree (type, status, next_retry_at) WHERE (((type)::text = 'withdraw'::text) AND ((status)::text = ANY ((ARRAY['processing'::character varying, 'waiting_for_gas'::character varying])::text[])));


--
-- TOC entry 5168 (class 1259 OID 33072)
...
--
-- TOC entry 5178 (class 1259 OID 33067)
...
--
-- TOC entry 5147 (class 1259 OID 32976)
...
--
-- TOC entry 5152 (class 1259 OID 32977)
...
--
-- TOC entry 5208 (class 1259 OID 33187)
...
--
-- TOC entry 5153 (class 1259 OID 32978)
...
--
-- TOC entry 5154 (class 1259 OID 33069)
...
--
-- TOC entry 5157 (class 1259 OID 32980)
...
--
-- TOC entry 5159 (class 1259 OID 32981)
...
--
-- TOC entry 5171 (class 1259 OID 32982)
...
--
-- TOC entry 5174 (class 1259 OID 32983)
...
--
-- TOC entry 5175 (class 1259 OID 32984)
...
--
-- TOC entry 5476 (class 2606 OID 34050)
-- Name: approved_bybit_subaccount_unfreeze_windows approved_bybit_subaccount_unfreeze_windows_fund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approved_bybit_subaccount_unfreeze_windows
    ADD CONSTRAINT approved_bybit_subaccount_unfreeze_windows_fund_id_fkey FOREIGN KEY (fund_id) REFERENCES public.funds(id) ON DELETE SET NULL;


--
-- TOC entry 5474 (class 2606 OID 34006)
-- Name: approved_bybit_withdrawal_windows approved_bybit_withdrawal_windows_fund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.approved_bybit_withdrawal_windows
    ADD CONSTRAINT approved_bybit_withdrawal_windows_fund_id_fkey FOREIGN KEY (fund_id) REFERENCES public.funds(id);


--
-- TOC entry 5477 (class 2606 OID 34075)
-- Name: bybit_subaccount_freeze_guard_events bybit_subaccount_freeze_guard_events_approved_window_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_subaccount_freeze_guard_events
    ADD CONSTRAINT bybit_subaccount_freeze_guard_events_approved_window_id_fkey FOREIGN KEY (approved_window_id) REFERENCES public.approved_bybit_subaccount_unfreeze_windows(id) ON DELETE SET NULL;


--
-- TOC entry 5478 (class 2606 OID 34070)
-- Name: bybit_subaccount_freeze_guard_events bybit_subaccount_freeze_guard_events_fund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_subaccount_freeze_guard_events
    ADD CONSTRAINT bybit_subaccount_freeze_guard_events_fund_id_fkey FOREIGN KEY (fund_id) REFERENCES public.funds(id) ON DELETE SET NULL;


--
-- TOC entry 5475 (class 2606 OID 34028)
-- Name: bybit_withdrawal_watchdog_events bybit_withdrawal_watchdog_events_approved_window_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bybit_withdrawal_watchdog_events
    ADD CONSTRAINT bybit_withdrawal_watchdog_events_approved_window_id_fkey FOREIGN KEY (approved_window_id) REFERENCES public.approved_bybit_withdrawal_windows(id);


--
-- TOC entry 5429 (class 2606 OID 33441)
...
--
-- TOC entry 5430 (class 2606 OID 33436)
...
--
-- TOC entry 5431 (class 2606 OID 33463)
...
--
-- TOC entry 5432 (class 2606 OID 33473)
...
--
-- TOC entry 5433 (class 2606 OID 33478)
...
--
-- TOC entry 5434 (class 2606 OID 33468)
...
--
-- TOC entry 5479 (class 2606 OID 56841)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_fund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_fund_id_fkey FOREIGN KEY (fund_id) REFERENCES public.funds(id) ON DELETE CASCADE;


--
-- TOC entry 5480 (class 2606 OID 56831)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_payout_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_payout_batch_id_fkey FOREIGN KEY (payout_batch_id) REFERENCES public.fund_negative_payout_batches(id) ON DELETE CASCADE;


--
-- TOC entry 5481 (class 2606 OID 56836)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_payout_leg_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_payout_leg_id_fkey FOREIGN KEY (payout_leg_id) REFERENCES public.fund_negative_payout_legs(id) ON DELETE CASCADE;


--
-- TOC entry 5482 (class 2606 OID 56826)
-- Name: fund_bsc_transaction_intents fund_bsc_transaction_intents_settlement_batch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fund_bsc_transaction_intents
    ADD CONSTRAINT fund_bsc_transaction_intents_settlement_batch_id_fkey FOREIGN KEY (settlement_batch_id) REFERENCES public.fund_settlement_batches(id) ON DELETE CASCADE;


--
-- TOC entry 5428 (class 2606 OID 33375)
...
--
-- TOC entry 5415 (class 2606 OID 33127)
...
--
-- TOC entry 5416 (class 2606 OID 33142)
...
--
-- TOC entry 5419 (class 2606 OID 33231)
...
--
-- TOC entry 5418 (class 2606 OID 33215)
...
--
-- TOC entry 5398 (class 2606 OID 32985)
...
--
-- TOC entry 5443 (class 2606 OID 33670)
...
--
-- TOC entry 5444 (class 2606 OID 33665)
...
--
-- TOC entry 5445 (class 2606 OID 33660)
...
--
-- TOC entry 5446 (class 2606 OID 33675)
...
--
-- TOC entry 5460 (class 2606 OID 33827)
...
--
-- TOC entry 5461 (class 2606 OID 33837)
...
--
-- TOC entry 5462 (class 2606 OID 33822)
...
--
-- TOC entry 5463 (class 2606 OID 33832)
...
--
-- TOC entry 5464 (class 2606 OID 33817)
...
--
-- TOC entry 5447 (class 2606 OID 33712)
...
--
-- TOC entry 5448 (class 2606 OID 33717)
...
--
-- TOC entry 5449 (class 2606 OID 33727)
...
--
-- TOC entry 5450 (class 2606 OID 33707)
...
--
-- TOC entry 5451 (class 2606 OID 33722)
...
--
-- TOC entry 5452 (class 2606 OID 33760)
...
--
-- TOC entry 5453 (class 2606 OID 33780)
...
--
-- TOC entry 5454 (class 2606 OID 33765)
...
--
-- TOC entry 5455 (class 2606 OID 33750)
...
--
-- TOC entry 5456 (class 2606 OID 33755)
...
--
-- TOC entry 5457 (class 2606 OID 33785)
...
--
-- TOC entry 5458 (class 2606 OID 33770)
...
--
-- TOC entry 5459 (class 2606 OID 33775)
...
--
-- TOC entry 5438 (class 2606 OID 33569)
...
--
-- TOC entry 5439 (class 2606 OID 33564)
...
--
-- TOC entry 5440 (class 2606 OID 33600)
...
--
-- TOC entry 5441 (class 2606 OID 33590)
...
--
-- TOC entry 5442 (class 2606 OID 33595)
...
--
-- TOC entry 5470 (class 2606 OID 33924)
...
--
-- TOC entry 5471 (class 2606 OID 33934)
...
--
-- TOC entry 5472 (class 2606 OID 33939)
...
--
-- TOC entry 5473 (class 2606 OID 33929)
...
--
-- TOC entry 5467 (class 2606 OID 33896)
...
--
-- TOC entry 5468 (class 2606 OID 33901)
...
--
-- TOC entry 5469 (class 2606 OID 33906)
...
--
-- TOC entry 5465 (class 2606 OID 33867)
...
--
-- TOC entry 5466 (class 2606 OID 33872)
...
--
-- TOC entry 5435 (class 2606 OID 33532)
...
--
-- TOC entry 5436 (class 2606 OID 33522)
...
--
-- TOC entry 5437 (class 2606 OID 33527)
...
--
-- TOC entry 5410 (class 2606 OID 33092)
...
--
-- TOC entry 5411 (class 2606 OID 33293)
...
--
-- TOC entry 5412 (class 2606 OID 33087)
...
--
-- TOC entry 5426 (class 2606 OID 33352)
...
--
-- TOC entry 5427 (class 2606 OID 33357)
...
--
-- TOC entry 5421 (class 2606 OID 33286)
...
--
-- TOC entry 5422 (class 2606 OID 33317)
...
--
-- TOC entry 5423 (class 2606 OID 33327)
...
--
-- TOC entry 5424 (class 2606 OID 33322)
...
--
-- TOC entry 5425 (class 2606 OID 33332)
...
--
-- TOC entry 5420 (class 2606 OID 33257)
...
--
-- TOC entry 5399 (class 2606 OID 32990)
...
--
-- TOC entry 5400 (class 2606 OID 32995)
...
--
-- TOC entry 5401 (class 2606 OID 33000)
...
--
-- TOC entry 5413 (class 2606 OID 33115)
...
--
-- TOC entry 5414 (class 2606 OID 33110)
...
--
-- TOC entry 5402 (class 2606 OID 33005)
...
--
-- TOC entry 5403 (class 2606 OID 33010)
...
--
-- TOC entry 5404 (class 2606 OID 33015)
...
--
-- TOC entry 5417 (class 2606 OID 33182)
...
--
-- TOC entry 5405 (class 2606 OID 33020)
...
--
-- TOC entry 5406 (class 2606 OID 33025)
...
--
-- TOC entry 5407 (class 2606 OID 33030)
...
--
-- TOC entry 5408 (class 2606 OID 33057)
...
--
-- TOC entry 5409 (class 2606 OID 33062)
...
-- Completed on 2026-07-27 18:17:51

--
-- PostgreSQL database dump complete
--

\unrestrict XjohjL8n8Z6ozNKj0xiERjl4bd6VZKx1LnvuP7xiiEh4SQU0gZWVTVR45UxliGH
