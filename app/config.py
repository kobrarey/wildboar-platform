...
class Settings(BaseSettings):
    ...
    FEE_WALLET_SWAP_GAS_WAIT_RETRY_SEC: int = 3600
    FEE_WALLET_SWAP_GAS_ALERT_COOLDOWN_SEC: int = 3600
    BYBIT_WITHDRAWALS_ENABLED: bool = False

    # --- stage 26: Bybit withdrawal watchdog ---
    BYBIT_WITHDRAWAL_WATCHDOG_ENABLED: bool = False
    BYBIT_WITHDRAWAL_WATCHDOG_POLL_SEC: int = 30
    BYBIT_WITHDRAWAL_WATCHDOG_LOOKBACK_MIN: int = 60
    BYBIT_WITHDRAWAL_WATCHDOG_CANCEL_UNEXPECTED: bool = False
    BYBIT_WITHDRAWAL_WATCHDOG_FAIL_CLOSED: bool = True
    BYBIT_WITHDRAWAL_WATCHDOG_API_ERROR_BUCKET_SEC: int = 3600

    # --- stage 26.1: Bybit subaccount freeze guard ---
    BYBIT_SUBACCOUNT_FREEZE_GUARD_ENABLED: bool = False
    BYBIT_SUBACCOUNT_FREEZE_GUARD_DRY_RUN: bool = True
    BYBIT_SUBACCOUNT_FREEZE_GUARD_POLL_SEC: int = 60
    BYBIT_SUBACCOUNT_FREEZE_GUARD_ALLOWED_FUND_CODES: str = "wb_test"
    BYBIT_SUBACCOUNT_FREEZE_GUARD_FAIL_CLOSED: bool = True
    BYBIT_SUBACCOUNT_FREEZE_GUARD_ALERT_COOLDOWN_SEC: int = 3600
    ...
    NEGATIVE_NET_UNIVERSAL_TRANSFER_AMOUNT_PRECISION: int = 2
    ...
    # --- stage 26.2.12: sent settlement transfer confirmation watcher ---
    SETTLEMENT_TRANSFER_CONFIRMATION_ENABLED: bool = False
    SETTLEMENT_TRANSFER_CONFIRMATION_FUND_CODES: str = ""
    SETTLEMENT_TRANSFER_CONFIRMATION_MIN_CONFIRMATIONS: int = 20
    SETTLEMENT_TRANSFER_CONFIRMATION_POLL_SEC: int = 60
    SETTLEMENT_TRANSFER_CONFIRMATION_LOOKBACK_HOURS: int = 72

    # --- stage 26.2.13: buy collection continuation worker ---
    SETTLEMENT_BUY_COLLECTION_CONTINUATION_ENABLED: bool = False
    SETTLEMENT_BUY_COLLECTION_CONTINUATION_FUND_CODES: str = ""
    SETTLEMENT_BUY_COLLECTION_CONTINUATION_POLL_SEC: int = 60

    SETTLEMENT_WALLET_TARGET_BNB_USD: Decimal = Decimal("100")
    SETTLEMENT_WALLET_MIN_GAS_BUFFER_MULT: Decimal = Decimal("1.20")
    SETTLEMENT_GAS_ALLOW_MIN_OPERATIONAL_FALLBACK: bool = True
    SETTLEMENT_GAS_TOPUP_FUND_CODES: str = ""
