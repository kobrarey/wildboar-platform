...
LEG_TYPE_RESIDUAL_USDT_EARN = "residual_usdt_earn"


EXECUTION_MODE_PLANNED = "planned"
EXECUTION_MODE_SKIPPED = "skipped"
EXECUTION_MODE_MARKET = "market"
EXECUTION_MODE_NATIVE_ICEBERG = "native_iceberg"
EXECUTION_MODE_SLICED_IOC_FALLBACK = "sliced_ioc_fallback"
EXECUTION_MODE_RESIDUAL_EARN = "residual_earn"
EXECUTION_MODE_RESIDUAL_CASH = "residual_cash"
EXECUTION_MODE_CASH_NOOP = "cash_noop"
EXECUTION_MODE_EARN_STAKE = "earn_stake"
EXECUTION_MODE_BUY_THEN_STAKE = "buy_then_stake"
...
COMPLETED_ALLOCATION_BATCH_STATUSES = {
    ALLOCATION_BATCH_STATUS_ALLOCATION_COMPLETED,
    ALLOCATION_BATCH_STATUS_ALLOCATION_COMPLETED_WITH_RESIDUAL_EARN,
    ALLOCATION_BATCH_STATUS_ALLOCATION_COMPLETED_WITH_RESIDUAL_CASH,
}

FAILED_ALLOCATION_BATCH_STATUSES = {
    ALLOCATION_BATCH_STATUS_FAILED_REQUIRES_REVIEW,
    ALLOCATION_BATCH_STATUS_ALLOCATION_FAILED_REQUIRES_REVIEW,
}

TERMINAL_ALLOCATION_BATCH_STATUSES = (
    COMPLETED_ALLOCATION_BATCH_STATUSES
    | FAILED_ALLOCATION_BATCH_STATUSES
)

# Allocation plan idempotency status sets.
# These are used by the allocation plan worker/service only.
...
ALLOCATION_PLAN_TERMINAL_STATUSES = TERMINAL_ALLOCATION_BATCH_STATUSES
