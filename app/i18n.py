...
MESSAGES = {
    "en": {
        ...
        "totp_not_configured": "TOTP encryption key is not configured",
        ...
        "totp_code_reused": "This authenticator code has already been used",
    ...
    "ru": {
        ...
        "totp_not_configured": "Ключ шифрования TOTP не настроен",
        ...
        "totp_code_reused": "Этот код аутентификатора уже был использован",
