...
MESSAGES = {
    "en": {
        ...
        "non_us_citizen_required": "Please confirm that you are not a citizen of the United States.",
        ...
        "totp_not_configured": "Authenticator verification is not configured.",
        "totp_setup_required": "Start TOTP setup first",
        "totp_invalid_code": "Invalid authenticator code.",
        "totp_not_enabled": "TOTP is not enabled",
        "totp_code_reused": "This authenticator code has already been used. Please wait for the next code.",
        "totp_verification_failed": "Authenticator verification failed. Please try again.",
        ...
        "no_verified_email": "No verified email. Verify your primary or backup email first.",
        "invalid_email_format": "Invalid email format",
        "email_already_used": "This email is already used by another user",
        "email_slot_empty": "This email slot is empty",
        "cannot_delete_last_email": "You can't delete the last email",
        "unsupported_slot": "Invalid slot",
        "portfolio_current_balance": "Current balance",
        "portfolio_daily_change": "Daily change",
        "portfolio_stable_balance": "USDT balance",
        "portfolio_active_funds": "Active funds",
        "portfolio_index_funds": "Index funds",
        "portfolio_test_funds": "Test funds",
        ...
        "insufficient_funds": "Insufficient available USDT balance.",
        "insufficient_shares": "Insufficient available fund shares.",
        "fund_not_found": "Fund not found.",
        "wallet_not_found": "Active wallet not found.",
    ...
    "ru": {
        ...
        "non_us_citizen_required": "Подтвердите, что вы не являетесь гражданином США.",
        "invalid_code": "Неверный код",
        "code_cooldown": "Код можно запрашивать не чаще 1 раза в минуту",
        "totp_already_enabled": "TOTP уже включён",
        "totp_required": "Введите код из приложения-аутентификатора.",
        "totp_not_configured": "Проверка через приложение-аутентификатор не настроена.",
        "totp_setup_required": "Сначала начните настройку TOTP",
        "totp_invalid_code": "Неверный код из приложения-аутентификатора.",
        "totp_not_enabled": "TOTP не включён",
        "totp_code_reused": "Этот код аутентификатора уже был использован. Дождитесь следующего кода.",
        "totp_verification_failed": "Не удалось выполнить проверку через приложение-аутентификатор. Попробуйте ещё раз.",
        "email_not_verified": "Эта почта не подтверждена",
        ...
        "no_verified_email": "Нет подтверждённой почты. Сначала подтвердите основную или резервную почту.",
        "invalid_email_format": "Некорректный e-mail",
        "email_already_used": "Эта почта уже используется другим пользователем",
        "email_slot_empty": "В этом слоте нет почты",
        "cannot_delete_last_email": "Нельзя удалить последнюю почту",
        "unsupported_slot": "Некорректный slot",
        "portfolio_current_balance": "Текущий баланс",
        "portfolio_daily_change": "Изменение за день",
        "portfolio_stable_balance": "Баланс USDT",
        "portfolio_active_funds": "Активные фонды",
        "portfolio_index_funds": "Индексные фонды",
        "portfolio_test_funds": "Тестовые фонды",
        ...
        "insufficient_funds": "Недостаточно доступного баланса USDT.",
        "insufficient_shares": "Недостаточно доступных паёв фонда.",
