...
# fund_bsc_transaction_intents.action_type
...
BSC_INTENT_ACTION_TYPES = frozenset(
    {
        BSC_INTENT_ACTION_NEGATIVE_SETTLEMENT_GAS_TOPUP,
        BSC_INTENT_ACTION_NEGATIVE_REDEEM_PAYOUT,
    }
...
# fund_bsc_transaction_intents.status
BSC_INTENT_STATUS_PREPARED = "prepared"
BSC_INTENT_STATUS_BROADCASTING = "broadcasting"
BSC_INTENT_STATUS_BROADCAST = "broadcast"
BSC_INTENT_STATUS_VISIBLE = "visible"
BSC_INTENT_STATUS_PENDING_CONFIRMATION = (
    "pending_confirmation"
)
BSC_INTENT_STATUS_CONFIRMED = "confirmed"
BSC_INTENT_STATUS_FAILED_REQUIRES_REVIEW = (
    "failed_requires_review"
)

BSC_INTENT_UNRESOLVED_STATUSES = frozenset(
    {
...
BSC_INTENT_TERMINAL_STATUSES = frozenset(
    {
